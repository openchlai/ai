...
te["yesno_r"] = { div:[], ac:["ay","","_sel","xx tt b05 cb",""], c:
[
        { s:["","%2"] },
        { div:["e"], c:[ { arg:["-0","","%0"] } ] }
]};
...
te["user_ed_"] = { div:["w58 ma mb sh__ gw_"], c:
[
	{ div:["x15 tt"], c:
	[
		{ s:["c xx y12 n b",null] },
	...
	[
		...
		{ p:["x25 t15","o"], c:
		[ 
			{ s:["c w13 y","Username"] }, { txt:["d w35 gw_ ba","w35 x y","","usn",":v:users:usn"] }, { div:["e"] } 
		]},
		{ p:["x25 t15","o"], c:
		[
			{ s:["c w13 y","First Name"] }, { txt:["d w35 gw_ ba","w35 x y","","fname",":v:users:contact_fname"] }, { div:["e"] }
		]},
		{ p:["x25 t15","o"], c:
		[
			{ s:["c w13 y","Last Name"] }, { txt:["d w35 gw_ ba","w35 x y","","lname",":v:users:contact_lname"] }, { div:["e"] }
		]},
		{ p:["x25 t15","o"], c:
		[
			{ s:["c w13 y","Phone"] }, { txt:["d w35 gw_ ba","w35 x y","","phone",":v:users:contact_phone"] }, { div:["e"] }
		]},
		{ p:["x25 t15","o"], c:
		[
			{ s:["c w13 y","Email"] }, { txt:["d w35 gw_ ba","w35 x y","","email",":v:users:contact_email"] }, { div:["e"] }
		]},
		{ p:["x25 t15","o"], c:
		[
			{ s:["c w13 y","Extension"] }, 
			{ div:["d w35 cd "], c:
			[
				{ span:["","", "Autogenerated: "] }, // { txt:["d w35 gw_ ba","w35 x y","","exten",":v:users:exten"] }, 
				{ span:["","",":v:users:exten"] }
			]},
			{ div:["e"] }
		]},
		...
		{ div:["x25 y15"], c:
                [
                        { s:["c w13  y","Is Active"] },
                        { div:["d","tag-r_--o--::yesno:0:2-is_active-%0-"], c:
                        [
                                { li:["ba w35 gw_","va"], c:[ { div:[], ev:["_dd"], c: // ls
                                [
                                        { p:["c w27 b03","o"], uchk:["tag",":v:users:is_active","","",""," ::yesno:0:2","is_active"," %0",""] },
                                        { div:["d w02 x y"],  c:[ { div:["h02 w02 awb"] } ] },
                                        { div:["e"] }
                                ]} ]},
                                { div:["dd w35 ba gw_ cb","vdd"], ev:["_undd"], c: // 
...
[
	...
	[ 
 	...
 	{ div:["x20 t15"], c:
        [
                { s:["c w10 x y cd","Is Active"] },
                { s:["c w30 x y cb",":v:users:is_active::yesno:2"] },
                { div:["e"] }
        ]},
...
te["user_vw_id"] = { div:["w60 ma bd sh__ y gw_","vddvw"], ev:["_undd"], c:
[
	{ div:["x20 y"], c:
	[
...
[
	...
	[ 
		...
		{ div:["e"], c:[ { arg:["fullname-1","","%5"] }, { arg:["name-5","","%5"] }, { arg:["role-6","","%6"] }, { arg:["exten-7","","%7"] } ] },
	]}
]};
...
[
	...
	{ div:["e"], c:[ { arg:["id-0","","%0"] }, { arg:["fullname-1","","%5"] }, { arg:["usn-2","","%5"] }, { arg:["role-6","","%6"] }, { arg:["exten-7","","%7"] } ] }
]};
...
[
	...
	{ f:["Is Active",null,		" ::yesno:0:2","is_active"," "] },
	{ f:["Created On",null,		" :d:dmy:0: ","created_on",""] },
	{ f:["Created By",null,		" %1","created_by_id"," %1"] },
	{ div:["e"] }
]};

te["user_f_tags"] = { user_f_tags_:[":k:users_f:usn", ":k:users_f:contact_fname", ":k:users_f:contact_lname", ":k:users_f:contact_phone", ":k:users_f:contact_email", ":k:users_f:exten", ":k:users_f:role", ":k:users_f:is_active", ":k:users_f:created_on", ":k:users_f:created_by_id"] };

te["user_f_tags_k"] = { user_f_tags_:[":k:users_k:usn:2", ":k:users_k:contact_fname:2", ":k:users_k:contact_lname:2", ":k:users_k:contact_phone:2", ":k:users_k:contact_email:2", ":k:users_k:exten:2", ":k:users_k:role:2", ":k:users_k:is_active:2", ":k:users_k:created_on:2", ":k:users_k:created_by_id:2"] };

te["user_f"] = { div:["w55 ma sh__ y gw_","vddvf"], ev:["_undd"], c:
[
...
//                        { div:["d","tag-r_--o--::yesno:0:2-is_active-%0-"], c:
		...
		{ div:["xx yy"], kf_c:["Is Active","tag_-r_--o--::yesno:0:2--is_active-%0-",  ":k:users_f:is_active",
""," ::yesno:0:1","","is_active"," %0","", 	":k:users_f:is_active", "yesnoo", "is_active"," ::yesno:0:2"," "] },

		{ div:["xx yy"], kf_d:["Created On"," :d:dmy:0: ","created_on",":k:users_f:created_on","created_on",":k:users_f:created_on"] },

		{ div:["xx yy"], kf_l:["Created By","tag_-r_--o--%5-user_id-created_by_id-%0-%5",   "user_lc_main-users",":k:users_f:created_by_id", 
...
[
	...
	[
		...
		{ div:["c w15 tt b05 h01_"], s:["xx",":v:users:role::user_role:1"] },
                { div:["c w10 tt b05 h01_"], s:["xx",":v:users:is_active::yesno:2"] },
...
[
	...
	[
		...
		{ k_a:["c w15","","cd","Role","da db",		"role",":k:users_k:role:2"] },
                { k_a:["c w10","","cd","Is Active","da db",     "exten",":k:users_k:exten:2"] },
...
te["user_list"] = { list:["user_title","user_nb","bl br ox","user_k","user_r","users","user_footer"] };
