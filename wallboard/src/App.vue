...
export default {
  ...
  setup() {
    ...
    const applyThemeClass = () => {
      // Apply the class to the root element so body/html background updates
    ...
    // Load dark mode preference on mount and apply to <html>
    onMounted(() => {
    ...
    // Keep DOM class in sync if state changes elsewhere
