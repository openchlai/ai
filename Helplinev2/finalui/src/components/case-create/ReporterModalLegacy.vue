    ...
    <div
      ...
      <div class="p-6 space-y-6 flex-1 overflow-y-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          <BaseInput label="Reporter Name" v-model="form.fname" placeholder="Name" />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <BaseInput label="Nearest Landmark" v-model="form.landmark" placeholder="Enter Landmark" />
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <BaseInput label="Alternative Phone" v-model="form.phone2" placeholder="Alt Phone" />
