  ...
  <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div class="relative bg-white dark:bg-neutral-900 rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto flex flex-col">
      ...
      <div class="p-6 space-y-6 flex-1 overflow-y-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
              ...
              <div class="flex gap-4">
                 ...
                 <select 
                    v-model="form.sharesHome"
                    class="w-full px-4 py-3 border rounded-lg text-sm bg-gray-50 focus:ring-2 focus:ring-amber-500 outline-none dark:bg-gray-700 dark:border-transparent dark:text-gray-100"
                 >
        ...
        <div>
           <BaseTextarea label="Additional Details" v-model="form.additionalDetails" placeholder="Details..." :rows="3" />
        </div>
