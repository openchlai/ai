  ...
  <div class="w-full rounded-lg p-4 shadow-xl border mb-4" :class="isDarkMode
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div class="flex flex-col">
        ...
        <input type="date" v-model="filters.callDateFrom" class="rounded-lg px-3 py-2 focus:outline-none focus:ring-2"
          :class="isDarkMode
      ...
      <div class="flex flex-col">
        ...
        <input type="date" v-model="filters.callDateTo" class="rounded-lg px-3 py-2 focus:outline-none focus:ring-2"
          :class="isDarkMode
            ? 'bg-neutral-800 border border-transparent text-gray-100 focus:ring-amber-500'
            : 'bg-gray-50 border border-transparent text-gray-900 focus:ring-amber-600'" />
      </div>
      ...
      <div class="flex flex-col">
        ...
        <input type="text" v-model="filters.user" placeholder="Enter user name"
          class="rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:border-transparent" :class="isDarkMode
      ...
      <div class="flex flex-col">
        ...
        <input type="text" v-model="filters.supervisor" placeholder="Enter supervisor name"
          class="rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:border-transparent" :class="isDarkMode
            ? 'bg-neutral-800 border border-transparent text-gray-100 placeholder-gray-500 focus:ring-amber-500'
            : 'bg-gray-50 border border-transparent text-gray-900 placeholder-gray-400 focus:ring-amber-600'" />
      </div>
      ...
      <div class="flex flex-col">
        ...
        <input type="number" v-model="filters.minScore" placeholder="0-100" min="0" max="100"
          class="rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:border-transparent" :class="isDarkMode
            ? 'bg-neutral-800 border border-transparent text-gray-100 placeholder-gray-500 focus:ring-amber-500'
            : 'bg-gray-50 border border-transparent text-gray-900 placeholder-gray-400 focus:ring-amber-600'" />
      </div>
      ...
      <div class="flex flex-col">
        ...
        <input type="date" v-model="filters.createdDateFrom"
          class="rounded-lg px-3 py-2 focus:outline-none focus:ring-2" :class="isDarkMode
            ? 'bg-neutral-800 border border-transparent text-gray-100 focus:ring-amber-500'
            : 'bg-gray-50 border border-transparent text-gray-900 focus:ring-amber-600'" />
      </div>
      ...
      <div class="flex flex-col">
        ...
        <input type="date" v-model="filters.createdDateTo" class="rounded-lg px-3 py-2 focus:outline-none focus:ring-2"
          :class="isDarkMode
            ? 'bg-neutral-800 border border-transparent text-gray-100 focus:ring-amber-500'
            : 'bg-gray-50 border border-transparent text-gray-900 focus:ring-amber-600'" />
      </div>
    ...
    <div class="flex gap-2 mt-4">
      <button @click="applyFilters"
        class="text-white px-6 py-2 rounded-lg transition-all duration-200 font-medium flex items-center gap-2" :class="isDarkMode
      ...
      <button @click="resetFilters" class="px-6 py-2 rounded-lg transition-all duration-200 font-medium border" :class="isDarkMode
