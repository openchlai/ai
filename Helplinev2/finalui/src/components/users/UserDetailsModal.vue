...
>>>>>>> main
      ...
      <button type="button" @click="$emit('close', false)" class="p-2 rounded-xl transition-colors duration-200" :class="isDarkMode
    ...
    <Transition name="slide-down">
      <div v-if="resetSuccess && newPassword" class="px-8 py-4 border-b" :class="isDarkMode
        ? 'bg-green-900/30 border-transparent'
        : 'bg-green-50 border-green-200'">
        <div class="flex items-start gap-3">
          <div class="mt-0.5 p-2 rounded-full" :class="isDarkMode
            ? 'bg-green-600/20'
            : 'bg-green-100'">
            <i-mdi-check-circle class="w-6 h-6" :class="isDarkMode ? 'text-green-400' : 'text-green-600'" />
          </div>
          <div class="flex-1">
            <h3 class="font-semibold mb-1" :class="isDarkMode ? 'text-green-400' : 'text-green-700'">
              Password Reset Successful!
            </h3>
            <p class="text-sm mb-3" :class="isDarkMode ? 'text-green-300' : 'text-green-600'">
              {{ resetMessage }}
            </p>
...
>>>>>>> main
            ...
            <p class="text-xs mt-3" :class="isDarkMode ? 'text-gray-400' : 'text-gray-600'">
...
>>>>>>> main
      ...
      <div>
        ...
        <span class="inline-block px-4 py-2 rounded-full text-sm font-medium uppercase border" :class="isDarkMode
      ...
      <div>
        ...
        <p class="text-sm font-mono" :class="isDarkMode ? 'text-gray-300' : 'text-gray-700'">
          {{ getValue('id') }}
        </p>
      </div>
      ...
      <div class="pt-2">
        ...
        <div class="flex items-center gap-2">
          <div class="w-2 h-2 rounded-full" :class="getValue('is_active') === '1'
            ? 'bg-green-500'
            : 'bg-red-500'"></div>
          <span class="text-sm font-medium" :class="getValue('is_active') === '1'
...
>>>>>>> main
      ...
      <template v-else>
        ...
        <button type="button" @click.prevent.stop="handleResetPassword" :disabled="resetting"
