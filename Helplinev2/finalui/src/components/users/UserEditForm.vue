...
>>>>>>> main
      ...
      <form @submit.prevent="submitForm" class="space-y-5">
        ...
        <div>
          ...
          <input v-model="form.usn" type="text" required
            class="w-full rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:border-transparent" :class="isDarkMode
        ...
        <div>
          ...
          <select v-model="form.role" required class="w-full rounded-lg px-4 py-3 focus:outline-none focus:ring-2"
            :class="isDarkMode
    ...
    <div class="px-8 py-5 border-t flex gap-3" :class="isDarkMode
      ...
      <button type="button" @click="emit('cancel')"
        class="px-8 py-3 rounded-lg transition-all duration-200 font-medium border" :class="isDarkMode
