  ...
  <div class="w-full rounded-lg p-4 shadow-xl border mb-4" :class="isDarkMode
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div class="flex flex-col">
        ...
        <input type="text" v-model="filters.username" placeholder="Enter username"
      ...
      <div class="flex flex-col">
        ...
        <input type="text" v-model="filters.firstName" placeholder="Enter first name"
          class="rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:border-transparent" :class="isDarkMode
            ? 'bg-neutral-800 border border-transparent text-gray-100 placeholder-gray-500 focus:ring-amber-500'
            : 'bg-gray-50 border border-transparent text-gray-900 placeholder-gray-400 focus:ring-amber-600'" />
      </div>
      ...
      <div class="flex flex-col">
        ...
        <select v-model="filters.role" class="rounded-lg px-4 py-3 focus:outline-none focus:ring-2" :class="isDarkMode
      ...
      <div class="flex flex-col">
        ...
        <input type="text" v-model="filters.createdBy" placeholder="Enter creator name"
          class="rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:border-transparent" :class="isDarkMode
            ? 'bg-neutral-800 border border-transparent text-gray-100 placeholder-gray-500 focus:ring-amber-500'
            : 'bg-gray-50 border border-transparent text-gray-900 placeholder-gray-400 focus:ring-amber-600'" />
      </div>
      ...
      <div class="flex flex-col">
        ...
        <input type="date" v-model="filters.createdDateFrom"
          class="rounded-lg px-4 py-3 focus:outline-none focus:ring-2" :class="isDarkMode
            ? 'bg-neutral-800 border border-transparent text-gray-100 focus:ring-amber-500'
            : 'bg-gray-50 border border-transparent text-gray-900 focus:ring-amber-600'" />
      </div>
      ...
      <div class="flex flex-col">
        ...
        <input type="date" v-model="filters.createdDateTo" class="rounded-lg px-4 py-3 focus:outline-none focus:ring-2"
          :class="isDarkMode
            ? 'bg-neutral-800 border border-transparent text-gray-100 focus:ring-amber-500'
            : 'bg-gray-50 border border-transparent text-gray-900 focus:ring-amber-600'" />
      </div>
