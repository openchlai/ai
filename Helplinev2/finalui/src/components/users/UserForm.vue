<template>
<<<<<<< HEAD
  <div class="max-w-3xl w-full rounded-xl shadow-2xl border max-h-[90vh] flex flex-col" :class="isDarkMode
...
>>>>>>> main
    ...
    <div class="overflow-y-auto px-8 py-6 flex-1">
      <form @submit.prevent="submitForm" class="space-y-5">
        ...
        <!-- Username -->
        <div>
          <label class="block mb-2 text-sm font-medium" :class="isDarkMode ? 'text-gray-300' : 'text-gray-700'">
            Username *
          </label>
          <input v-model="form.usn" type="text" required
            class="w-full rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:border-transparent" :class="isDarkMode
        ...
        <div>
          ...
          <input v-model="form.fname" type="text" required
            class="w-full rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:border-transparent" :class="isDarkMode
              ? 'bg-gray-700 border border-transparent text-gray-100 placeholder-gray-500 focus:ring-blue-500'
              : 'bg-gray-50 border border-transparent text-gray-900 placeholder-gray-400 focus:ring-amber-600'" />
        </div>
        ...
        <div>
          ...
          <input v-model="form.lname" type="text" required
            class="w-full rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:border-transparent" :class="isDarkMode
              ? 'bg-gray-700 border border-transparent text-gray-100 placeholder-gray-500 focus:ring-blue-500'
              : 'bg-gray-50 border border-transparent text-gray-900 placeholder-gray-400 focus:ring-amber-600'" />
        </div>
        ...
        <div>
          ...
          <select v-model="form.role" required class="w-full rounded-xl px-4 py-3 focus:outline-none focus:ring-2"
            :class="isDarkMode
        ...
        <div>
          ...
          <input v-model="form.exten" type="text"
            class="w-full rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:border-transparent" :class="isDarkMode
              ? 'bg-gray-700 border border-transparent text-gray-100 placeholder-gray-500 focus:ring-blue-500'
              : 'bg-gray-50 border border-transparent text-gray-900 placeholder-gray-400 focus:ring-amber-600'" />
        </div>
        ...
        <div class="flex items-center gap-2 pt-2">
          <input type="checkbox" v-model="isActive" class="h-4 w-4 rounded text-blue-600 focus:ring-blue-500" :class="isDarkMode
    ...
    <div class="px-8 py-5 border-t flex gap-3" :class="isDarkMode
      ...
      <button @click="submitForm"
        class="flex-1 text-white py-3 rounded-xl transition-all duration-200 font-medium flex items-center justify-center gap-2"
        :class="isDarkMode
      ...
      <button type="button" @click="emit('cancel')"
        class="px-8 py-3 rounded-xl transition-all duration-200 font-medium border" :class="isDarkMode
