  ...
  >
      ...
      <form @submit.prevent="submitForm" class="space-y-5">
        ...
        <div>
          ...
          <input 
            ...
            type="text" 
            required 
            class="w-full rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:border-transparent"
            :class="isDarkMode 
    ...
    >
      ...
      <button
        type="button"
        @click="emit('cancel')"
        class="px-8 py-3 rounded-xl transition-all duration-200 font-medium border"
        :class="isDarkMode 
