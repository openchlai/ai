    ...
    <div v-else>
      ...
      <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex items-center gap-2" :class="isDarkMode ? 'text-gray-300' : 'text-gray-700'">
          <i-mdi-clipboard-check class="w-5 h-5" :class="isDarkMode ? 'text-amber-500' : 'text-amber-700'" />
          <span class="text-sm">
...
>>>>>>> main
      ...
      <!-- Pagination Controls -->
      <Pagination :paginationInfo="qaStore.paginationInfo" :hasNextPage="qaStore.hasNextPage"
