...
from app.core.realtime.tokenizer import get_tokenizer, LANGUAGES, TO_LANGUAGE_CODE
from app.core.realtime.decoding import DecodingOptions, DecodingResult, DecodingTask
from app.core.realtime.mel import log_mel_spectrogram, FRAMES_PER_SECOND, HOP_LENGTH, N_FRAMES, N_SAMPLES, SAMPLE_RATE
from app.core.realtime.model import Whisper, ModelDimensions
from app.models.whisper_model import WhisperModel 
from app.core.realtime.utils import exact_div
...
def load_model():
	...
	# model_path = whisper_model.model_path

	model_dir = whisper_model.model_path
